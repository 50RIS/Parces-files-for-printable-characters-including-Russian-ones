/* gcc -o the_compiled_binary_name Parsing_files_for_printable_characters_including_Russian_alphabet.c # How to compile manually _! ! !_! !_ */
#include <unistd.h>
#include <stdlib.h>
#include <stdio.h>
#include <sys/stat.h>
